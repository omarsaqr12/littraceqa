...
\textbf{0.7647}, up from \textbf{0.4563} for our first submission and
...
then it stopped improving. Every subsequent gain --- to $0.7647$ --- came from
...
\textbf{\;+ three row sets restored (final)} & \textbf{0.9704} & \textbf{0.7262} & \textbf{0.98} & \textbf{0.5151} & \textbf{0.2976} & \textbf{0.7647} \\
\bottomrule
\end{tabular}
...
$0.5151$ and $0.2976$, and together they account for the majority of our
remaining headroom.
...
$0.7647$ additionally includes per-question auditing against source PDFs and
...
Our LitTraceQA submission reached an official $0.7647$, and the useful part of
